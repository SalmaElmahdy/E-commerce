...
def add_to_cart(request,product_id):
    ...
    _add_product_to_cart(request,product,cart,product_variation)
...
def _add_product_to_cart(request,product,cart,product_variation):
    ...
    if is_cart_item_exists:
        _create_or_update_item(request,product,product_variation,cart)
    else:
       _create_cart_item(request,product,product_variation,cart)
   
def _create_or_update_item(request,product,product_variation,cart):
    if request.user.is_authenticated:
        cart_item=Cart_Item.objects.filter(product=product,user=request.user)
    else:
...
def _create_cart_item(request,product,product_variation,cart):
    if request.user.is_authenticated:
